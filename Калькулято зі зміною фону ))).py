...
class CalculatorApp(QWidget):
    ...
    def init_ui(self):
        ...
        buttons = [
            ...
            ('.', self.add_to_display),
            ('%', self.add_percent),#знаходження відсотка
            ('+', self.add_to_display),
            ('C', self.clear_display),#очищення
            ('=', self.calculate_result),#корінь
            ('√', self.calculate_square_root),
            ('Змінити фон на блакитний', self.change_background_to_blue),
            ('Змінити фон на жовтий', self.change_background_to_yellow),
            ('Змінити фону на білий ', self.change_background_to_blue_yellow),
        ]
    ...
    def change_background_to_yellow(self):
        self.setStyleSheet("background-color: yellow;")

    def change_background_to_blue_yellow(self):
